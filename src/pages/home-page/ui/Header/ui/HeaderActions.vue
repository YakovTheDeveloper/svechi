...
<template>
	<div class="header-actions">
		...
		<div class="header-actions__contacts">
			<component
				is="button"
				class="header-actions__contacts-item"
				@click="onWriteUs"
			>
				<div
					class="header-actions__contacts-item-icons header-actions__contacts-item-icons_write-us"
				>
					<img :src="adminIcon" alt="contact-icon" />
					<img
						:src="phoneIcon"
						alt="contact-icon"
						class="header-actions__contacts-item-icons-phone"
					/>
				</div>
