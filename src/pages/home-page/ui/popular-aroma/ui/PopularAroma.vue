...
const slides = [
    { imgUrl: icon1, id: 1, title: 'Ладан' },
    { imgUrl: icon2, id: 2, title: 'Кожа и древесина' },
    { imgUrl: icon3, id: 3, title: 'Марокканский кашемир' },
    { imgUrl: icon4, id: 4, title: 'Дерево сандалаи жасмин' },
    { imgUrl: icon5, id: 5, title: 'Амбра, табак' },
